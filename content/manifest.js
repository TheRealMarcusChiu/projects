...
//
// Source extracted from github.com/TheRealMarcusChiu/projects (data.js +
// images/). The site reads everything off this file dynamically: the number
// of projects, all copy, dates, tech, links, and accent colours. There is no
// project data hard-coded in the HTML.
//
// Fields:
//   id          – stable slug (also the key into content/covers.js data URIs)
//   title       – project name
//   description – one-line caption
//   url         – live site link
//   displayUrl  – domain shown in the UI (no protocol)
//   cover       – cover/screenshot image (relative to content/)
//   coverW/H    – intrinsic pixel dimensions of the cover image
//   tag         – short category badge
//   category    – filter group: visualization | interactive | tools | experiments
//   tech        – primary tech stack (array, shown as chips)
//   dateCreated – ISO date (YYYY-MM-DD); placeholder/random values
//   accent      – hex tint colour used for the project's 3D slab
//
// Loaded as a classic script:  <script src="content/manifest.js"></script>
//   → window.PROJECTS and window.PROJECT_FILTERS
// (Also exposes module.exports for CommonJS tooling.)
// ─────────────────────────────────────────────────────────────────────────
...
var PROJECTS = [
  ...
  },
  {
    ...
    tech: ['JavaScript', 'Canvas', 'Neural Networks'],
  ...
  },
  {
    ...
    tech: ['Web Audio API', 'DSP', 'JavaScript'],
  ...
  },
  {
    ...
    tag: 'Stats',
    category: 'visualization',
    tech: ['JavaScript', 'Statistics', 'Visualization'],
